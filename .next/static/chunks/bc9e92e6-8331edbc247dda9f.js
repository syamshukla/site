"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,n){n.d(t,{IO:function(){return ij},JU:function(){return iw},PL:function(){return i5},QT:function(){return i9},ad:function(){return iE},ar:function(){return iH},hJ:function(){return iy},r7:function(){return i6}});var r,i,s=n(3991),a=n(5538),o=n(6914),l=n(8745),u=n(613);n(2601);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iz{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ip(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new i$(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(iK("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class i$ extends iz{data(){return super.data()}}function iK(e,t){return"string"==typeof t?iq(e,t):t instanceof iS?t._internalPath:t._delegate._internalPath}class iG{}class iQ extends iG{}function ij(e,t,...n){let r=[];for(let i of(t instanceof iG&&r.push(t),function(e){let t=e.filter(e=>e instanceof iY).length,n=e.filter(e=>e instanceof iW).length;if(t>1||t>0&&n>0)throw new E(_.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}class iW extends iQ{constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}static _create(e,t,n){return new iW(e,t,n)}_apply(e){let t=this._parse(e);return iZ(e._query,t),new im(e.firestore,e.converter,e9(e._query,t))}_parse(e){let t=iL(e.firestore),n=function(e,t,n,r,i,s,a){let o;if(i.isKeyField()){if("array-contains"===s||"array-contains-any"===s)throw new E(_.INVALID_ARGUMENT,`Invalid Query. You can't perform '${s}' queries on documentId().`);if("in"===s||"not-in"===s){iJ(a,s);let t=[];for(let n of a)t.push(iX(r,e,n));o={arrayValue:{values:t}}}else o=iX(r,e,a)}else"in"!==s&&"not-in"!==s&&"array-contains-any"!==s||iJ(a,s),o=function(e,t,n,r=!1){return iM(n,e.pu(r?4:3,t))}(n,t,a,"in"===s||"not-in"===s);return eF.create(i,s,o)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value);return n}}function iH(e,t,n){let r=iK("where",e);return iW._create(r,t,n)}class iY extends iG{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new iY(e,t)}_parse(e){let t=this._queryConstraints.map(t=>t._parse(e)).filter(e=>e.getFilters().length>0);return 1===t.length?t[0]:eP.create(t,this._getOperator())}_apply(e){let t=this._parse(e);return 0===t.getFilters().length?e:(function(e,t){let n=e,r=t.getFlattenedFilters();for(let e of r)iZ(n,e),n=e9(n,e)}(e._query,t),new im(e.firestore,e.converter,e9(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return"and"===this.type?"and":"or"}}function iX(e,t,n){if("string"==typeof(n=(0,l.m9)(n))){if(""===n)throw new E(_.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!e2(t)&&-1!==n.indexOf("/"))throw new E(_.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);let r=t.path.child(F.fromString(n));if(!q.isDocumentKey(r))throw new E(_.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return eT(e,new q(r))}if(n instanceof ip)return eT(e,n._key);throw new E(_.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${iu(n)}.`)}function iJ(e,t){if(!Array.isArray(e)||0===e.length)throw new E(_.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function iZ(e,t){let n=function(e,t){for(let n of e)for(let e of n.getFlattenedFilters())if(t.indexOf(e.op)>=0)return e.op;return null}(e.filters,function(e){switch(e){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(null!==n)throw n===t.op?new E(_.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new E(_.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`)}class i0{convertValue(e,t="none"){switch(eg(e)){case 0:return null;case 1:return e.booleanValue;case 2:return el(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(eu(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw v()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){let n={};return Y(e,(e,r)=>{n[e]=this.convertValue(r,t)}),n}convertGeoPoint(e){return new iN(el(e.latitude),el(e.longitude))}convertArray(e,t){return(e.values||[]).map(e=>this.convertValue(e,t))}convertServerTimestamp(e,t){switch(t){case"previous":let n=ec(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(ed(e));default:return null}}convertTimestamp(e){let t=eo(e);return new V(t.seconds,t.nanos)}convertDocumentKey(e,t){let n=F.fromString(e);nc(n)||v();let r=new em(n.get(1),n.get(3)),i=new q(n.popFirst(5));return r.isEqual(t)||g(`Document ${i} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function i9(e){e=ih(e,ip);let t=ih(e.firestore,i_);return(function(e,t,n={}){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new r8({next:s=>{t.enqueueAndForget(()=>rk(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new E(_.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new E(_.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rL(new e0(n.path),s,{includeMetadataChanges:!0,J_:!0});return rb(e,a)})(await ir(e),e.asyncQueue,t,n,r)),r.promise})(iT(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new i8(e);return new i2(e,i,t._key,r,new i1(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class i8 extends i0{constructor(e){super(),this.firestore=e}convertBytes(e){return new iC(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ip(this.firestore,null,t)}}function i5(e){e=ih(e,im);let t=ih(e.firestore,i_),n=iT(t),r=new i8(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new E(_.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new r8({next:n=>{t.enqueueAndForget(()=>rk(e,a)),n.fromCache&&"server"===r.source?i.reject(new E(_.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rL(n,s,{includeMetadataChanges:!0,J_:!0});return rb(e,a)})(await ir(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new i3(t,r,e,n)))}function i6(e,t,n,...r){var i;e=ih(e,ip);let s=ih(e.firestore,i_),a=iL(s);return i=[("string"==typeof(t=(0,l.m9)(t))||t instanceof iS?function(e,t,n,r,i,s){let a=e.pu(1,t,n),o=[iP(t,r,n)],u=[i];if(s.length%2!=0)throw new E(_.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iP(t,s[e])),u.push(s[e+1]);let h=[],c=eD.empty();for(let e=o.length-1;e>=0;--e)if(!function(e,t){return e.some(e=>e.isEqual(t))}(h,o[e])){let t=o[e],n=u[e];n=(0,l.m9)(n);let r=a.Ru(t);if(n instanceof iV)h.push(t);else{let e=iM(n,r);null!=e&&(h.push(t),c.set(t,e))}}let d=new er(h);return new ik(c,d,a.fieldTransforms)}(a,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.pu(1,t,n);iF("Data must be an object, but it was:",i,r);let s=[],a=eD.empty();Y(r,(e,r)=>{let o=iq(t,e,n);r=(0,l.m9)(r);let u=i.Ru(o);if(r instanceof iV)s.push(o);else{let e=iM(r,u);null!=e&&(s.push(o),a.set(o,e))}});let o=new er(s);return new ik(a,o,i.fieldTransforms)}(a,"updateDoc",e._key,t)).toMutation(e._key,tS.exists(!0))],function(e,t){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>r$(await it(e).then(e=>e.syncEngine),t,n)),n.promise}(iT(s),i)}new WeakMap,function(e=!0){d=s.Jn,(0,s.Xd)(new a.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new i_(new A(t.getProvider("auth-internal")),new D(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new E(_.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new em(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,s.KN)(h,"4.4.0",void 0),(0,s.KN)(h,"4.4.0","esm2017")}()}}]);